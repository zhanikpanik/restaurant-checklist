    ...
    return (
      ...
      >
        <div className="text-center pt-2">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-1">Link is ready!</h3>
          <p className="text-sm text-gray-500 mb-8 px-4">
            Send this registration link to your staff member. It will expire in 24 hours.
          </p>
          ...
          <div className="space-y-3 mb-8">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Quick Share</p>
