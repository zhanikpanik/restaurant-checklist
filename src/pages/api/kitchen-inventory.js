...
export async function GET() {
    ...
    try {
        console.log('🍽️ Fetching KITCHEN inventory and ingredient details from Poster...');
        ...
        // 2. Fetch inventory leftovers for the KITCHEN storage
        const leftoversRes = await fetch(`${baseUrl}/storage.getStorageLeftovers?token=${token}&storage_id=1`);
        ...
        console.log(`✅ Loaded ${leftovers.length} KITCHEN leftovers from Poster.`);
