...
export function SupplierGroupCard({
  ...
  const getOrdersCountText = (count: number) => {
    if (count === 1) return "1 заказ";
    if (count < 5) return `${count} заказа`;
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                {getOrdersCountText(group.orders.length)}
              </p>
            </div>
          </div>
          <svg
        ...
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            onClick={(e) => {
              e.stopPropagation();
              onSendWhatsApp(supplierName, group.items, group.orders[0].created_at);
            }}
            leftIcon={
