                ...
                {hasChanges && (
                  <div className="fixed bottom-6 left-0 right-0 px-4 z-50 flex justify-center">
                    <button
                      ...
                      disabled={updating}
                      className="bg-brand-500 hover:bg-brand-600 text-white font-bold py-3 px-8 rounded-full shadow-lg flex items-center gap-2 transition-all transform hover:scale-105 active:scale-95 disabled:opacity-70"
                    >
                      {updating ? (
                        ...
                        {pendingBySupplier.map(([supplier, group]) => (
                          <div key={supplier} className="px-4 py-4">
                            ...
                            <div className="flex gap-2">
                              <button
                                onClick={() => copyOrderToClipboard(supplier, group.items)}
                                className="px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl text-sm font-medium transition-colors flex items-center justify-center gap-2"
                              ...
                              <button
                                ...
                                className="flex-1 bg-green-600 hover:bg-green-700 text-white px-4 py-3 rounded-xl text-sm font-medium transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                              >
