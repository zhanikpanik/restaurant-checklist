                        ...
                        >
                          ...
                          <div className="flex items-start justify-between mb-2 md:mb-3">
                            ...
                            {!product.poster_ingredient_id && (
                              <button
                                ...
                                className="p-1.5 md:p-2 text-red-500 hover:bg-red-50 rounded transition-colors flex-shrink-0"
                              >
                                <svg className="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                </svg>
                          ...
                          <div className="space-y-1.5 md:space-y-2 mb-3 md:mb-4 text-xs md:text-sm">
                            <div className="flex items-center text-gray-600">
                              <span className="font-medium w-20 md:w-24">Категория:</span>
                              <span className="text-gray-900">{product.category_name || "—"}</span>
                            </div>
                            <div className="flex items-center text-gray-600">
                              <span className="font-medium w-20 md:w-24">Единица:</span>
                              <span className="text-gray-900">{product.unit || "—"}</span>
                            </div>
                            <div className="flex items-center text-gray-600">
                              <span className="font-medium w-20 md:w-24">Секция:</span>
                              <span className="text-gray-900">📍 {product.section_name || "Без секции"}</span>
                            </div>
                          </div>
                          ...
                          <button
                            ...
                            className="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 md:py-2.5 px-3 rounded-lg text-sm md:text-base font-medium transition-colors"
                          >
                            Редактировать
                          </button>
                        </div>
